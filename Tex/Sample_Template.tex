...
\documentclass[10pt]{article} % This is what your document is
...
%\usepackage{xcolor} % For colours (https://www.overleaf.com/learn/latex/Using_colours_in_LaTeX)
...
% Commands to make your code look neater. The black square for proofs and the spacing vv symbol (credits to Alfonso Gracia Saz for the idea. RIP)
